...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 10 2016 г., 18:54
...
(53, 6, 'Незабутній відпочинок серед Карпатських гір|Unforgettable rest among Carpathian|', 'Ми завжди раді Вам|We will happy to see you|', 0.00, 0, '["upload\\/articles\\/53\\/images\\/slide-1.jpg"]', '0000-00-00 00:00:00', '||', '||', '||', 1, '2016-10-10 12:17:52', '2016-10-10 12:45:20'),
(54, 6, 'Ви можете відпочити у найкращій спа-зоні|You can have a rest at the best Spa zone|', 'Ми дбаємо про Ваш відпочинок|We think about your rest|', 0.00, 0, '["upload\\/articles\\/54\\/images\\/slide-2.jpg"]', '0000-00-00 00:00:00', '||', '||', '||', 1, '2016-10-10 12:22:08', '2016-10-10 12:51:30');
