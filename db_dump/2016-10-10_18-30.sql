...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 10 2016 г., 18:31
...
(53, 6, 'Передбачуємо текст слайда з заголовком №1|We provide the text of a slide with title №1|', 'З коротким описом|With the short description|', 0.00, 0, '["upload\\/articles\\/53\\/images\\/slide-1.jpg"]', '0000-00-00 00:00:00', '||', '||', '||', 1, '2016-10-10 12:17:52', '2016-10-10 12:20:18'),
(54, 6, 'Передбачуємо текст слайда з заголовком №2|We provide the text of a slide with title №2|', 'З коротким описом|With the short description|', 0.00, 0, '["upload\\/articles\\/54\\/images\\/slide-2.jpg"]', '0000-00-00 00:00:00', '||', '||', '||', 1, '2016-10-10 12:22:08', '2016-10-10 12:22:42');
...
(6, 'Слайдер', 'slider', '["title","description","meta_title","meta_description","gallery","active"]', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
